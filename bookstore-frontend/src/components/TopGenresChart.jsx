...
export default function TopGenresChart() {
  ...
  if (!genres || !genres.length) return <p className="text-sm text-gray-500">No genre data available</p>;
  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-md">
      <h2 className="text-lg font-semibold mb-3 text-purple-700">Top-Selling Genres</h2>
      <Pie data={data} />
    </div>
  );
}
