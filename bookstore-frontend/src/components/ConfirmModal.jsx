...
export default function ConfirmModal({
    ...
    return (
        ...
        >
            <div
                ref={modalRef}
                className={`bg-white rounded-2xl p-6 w-full max-w-sm shadow-xl border border-gray-200 transform transition-all duration-300 ${visible ? "scale-100 translate-y-0" : "scale-95 translate-y-4"
                    }`}
            >
                {/* Header */}
                ...
                <div className="flex justify-end gap-3">
                    ...
                    <button
                        ...
                        className={`px-4 py-1.5 rounded-full text-white text-sm transition ${status === "error"
