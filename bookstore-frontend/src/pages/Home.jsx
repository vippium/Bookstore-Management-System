            ...
            >
              {({ open }) => (
                <div className="relative">
                  <Listbox.Button
                    className={`w-full py-2 px-4 border rounded-full shadow-sm bg-white text-sm flex justify-between items-center transition-all ${open
                  ...
                  <Listbox.Options className="absolute mt-2 w-full bg-white border border-blue-200 rounded-xl shadow-lg z-10 max-h-60 overflow-auto text-sm animate-fade-in origin-top">
                    {genres.map((genre, i) => (
                      <Listbox.Option
                        ...
                        value={genre}
                        className={({ active }) =>
                          `px-4 py-2 cursor-pointer text-center ${active
        ...
        <div className="relative w-full md:w-40 md:ml-auto">
          <Listbox value={activeFilterType} onChange={setActiveFilterType}>
            {({ open }) => (
              <div className="relative">
                <Listbox.Button
                  className={`w-full py-2 px-4 border rounded-full shadow-sm bg-white text-sm flex items-center transition-all ${open
                    ? "border-blue-400 ring-2 ring-blue-400"
                    : "border-blue-300"
                    }`}
                >
          ...
          <div className="flex justify-center mt-10 gap-2 flex-wrap">
            ...
            {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
              <button
                ...
                className={`px-4 py-1 rounded-full transition border ${currentPage === page
