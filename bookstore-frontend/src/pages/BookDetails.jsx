...
export default function BookDetails() {
  ...
  useEffect(() => {
    if (wishlist && book) {
      setIsWishlisted(wishlist.some(item => item.book && item.book._id === book._id));
    }
  }, [wishlist, book]);
      ...
      <div className="max-w-5xl mx-auto p-6 flex flex-col md:flex-row gap-8 animate-zoom-in">
        ...
        <div className="md:w-1/2 flex flex-col justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-blue-800 mt-2 mb-1">₹{book.price}</p>
          ...
          <div className="flex items-center gap-2 mt-4">
            ...
            <span className="text-md font-semibold w-8 text-center">{quantity}</span>
            <button
          ...
          <div className="flex gap-3 flex-wrap mt-4">
              ...
              <button
                ...
                className={`px-6 py-2.5 rounded-full font-semibold transition duration-300 shadow-md
                  ${!user || book.stock < 1
                    ...
                    : `bg-blue-600 text-white hover:bg-blue-700 ${animateCart ? "scale-105" : ""}`
                  }`}
              >
                Add to Cart
              </button>
            ...
            >
              ...
              >
                <Heart
                  size={18}
                  className={`${isWishlisted ? "fill-red-500" : "fill-transparent"}`}
                />
